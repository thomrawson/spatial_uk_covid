...
beta_trajectories <- rstan::traceplot(stanfit, pars=c('sqrtQ','betas'), nrow = 1)
png(file="Case_Outputs\\beta_trajectories.png",
...
zetas_trajectories <- rstan::traceplot(stanfit, pars=c('zetas'))
png(file="Case_Outputs\\zetas_trajectories.png",
    width=1440, height=1080, res = 150)
plot(zetas_trajectories)
dev.off()
