...
for(i in 2:final_week){
  ...
  x[j,,17] <-Reduced_Data$cumVaccPercentage_FirstDose/100 
  x[j,,18] <-Reduced_Data$cumVaccPercentage_SecondDose/100 
  x[j,,19] <-Reduced_Data$cumVaccPercentage_ThirdDose/100 
